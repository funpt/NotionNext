...
const BLOG = {
  ...
  AUTHOR: 'FunPT', // 您的昵称 例如 tangly1024
  BIO: '复盎运动康复🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.funpt.com', // 网站地址
  KEYWORDS: 'Notion, 博客,FunPT,复盎运动康复，运动康复', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'coolsurfer@qq.com', // 邮箱地址 例如mail@tangly1024.com
